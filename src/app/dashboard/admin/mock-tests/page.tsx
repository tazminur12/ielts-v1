...
// Fallback badge colors by order / free flag
...
export default function AdminMockTestsPage() {
  ...
  const handleDelete = async (test: Test) => {
    const confirm = await Swal.fire({
      title: "Delete Test?",
      text: `This will permanently delete "${test.title}" and ALL its sections, questions and attempts.`,
      icon: "warning",
      showCancelButton: true,
...
function CreateTestModal({
  ...
  const [form, setForm] = useState({
    ...
    type: "Academic",
    module: "listening",
    accessLevel: "",       // will be set once plans load
    duration: "",
    difficulty: "medium",
    rating: "",
    usersCount: "",
  ...
  // Auto-select first plan as default when plans load
  useEffect(() => {
    ...
    try {
      const res = await fetch("/api/admin/tests", {
        ...
        body: JSON.stringify({
          ...
          targetBand: form.targetBand ? Number(form.targetBand) : undefined,
          tags: form.tags
      ...
      Swal.fire("Created!", "Test has been created as Draft.", "success");
      onSuccess();
    } catch (err: any) {
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-100">
          <h2 className="text-lg font-bold text-gray-900">
            Create New {examType === "mock" ? "Mock" : "Practice"} Test
          </h2>
          <p className="text-sm text-gray-500 mt-1">Test will be saved as Draft</p>
        </div>
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. IELTS Mock Test - Academic 1"
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g. Full Test, New, Premium"
              className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div>
...
function EditTestModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      Swal.fire("Saved!", "Test has been updated.", "success");
      onSuccess();
    } catch (err: any) {
      Swal.fire("Error", err.message, "error");
    } finally {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
        <div className="p-6 border-b border-gray-100">
          <h2 className="text-lg font-bold text-gray-900">Edit Mock Test</h2>
